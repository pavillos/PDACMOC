#' @title Chan-Seng-Yue classifier
#' 
#' @author Villoslada-Blanco, Pablo
#' 
#' @description
#' Classification of tumor according to Chan-Seng-Yue et al., 2020
#' 
#' @import reticulate
#'
...
#'
#' @return results_chan: classification according to Chan-Seng_Yue
#' 
#' @example ./inst/examples/example.R

chan.classify <- function(new_samples) {
  
  # Get Chang-Sen-Yue genes and extract common genes
  file1 <- system.file('training_data', 'all_Chan.csv', package = 'PDACMOC')
  ...
  message('Chan-Seng-Yue: the expression of ', genes_imputed, ' genes will be imputed')
  ...
  file2 <- system.file('models', 'Chan.pkl', package = 'PDACMOC')
